    ...
    <div className="absolute bottom-0 left-0 right-0 z-30 max-w-[100vw] overflow-hidden border-t border-white/20 bg-slate-950/80 px-3 py-2 text-white shadow-[0_-16px_40px_rgba(15,23,42,0.28)] backdrop-blur-xl md:px-4">
      <div className="mx-auto flex max-w-7xl flex-col gap-2 md:flex-row md:items-center">
        <button
          ...
          className="hidden h-9 w-9 shrink-0 items-center justify-center rounded-md border border-white/20 bg-white/10 font-mono text-sm font-semibold transition-colors hover:bg-white/18 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300 md:inline-flex"
        >
          &lt;
        </button>
        <div className="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto pb-1">
          {times.map((time, index) => (
            <button
              ...
              className={`h-9 min-w-14 rounded-md px-3 font-mono text-sm font-semibold transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300 ${
